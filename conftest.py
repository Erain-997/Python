...
class ProgressTerminalReporter(TerminalReporter):
    ...
    def pytest_collection_finish(self, session):
        self.case_total = self._numcollected
    ...
    def send_progress_info(self):
        _thread.start_new_thread(self._send_progress_info, ())

    def _send_progress_info(self):
        pass
