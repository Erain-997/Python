...
class MainScene(QtWidgets.QMainWindow):
    ...
    def init_ui(self):
        ...
        self.playlist_button_1.setIcon(QtGui.QIcon('repository/pic/r1.jpg'))
        ...
        self.playlist_button_2.setIcon(QtGui.QIcon('repository/pic/r1.jpg'))
        ...
        self.playlist_button_3.setIcon(QtGui.QIcon('repository/pic/r1.jpg'))
        ...
        self.playlist_button_4.setIcon(QtGui.QIcon('repository/pic/r1.jpg'))
        ...
        self.init_main.setFixedSize(20, 20)  # 设置按钮大小
