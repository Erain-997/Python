...
# @allure.title("lpReport")
def ffff_appReport_lpReport(client=None, clientWidth=None, clientHeight=None, devicePixelRatio=None, ttp=None,
    ...
    resp = client.post(f"{base_url}/ffff/appReport/lpReport", expected,
...
if __name__ == "__main__":
    print("▶ 调用 ffff_appReport_lpReport ...")
    ffff_appReport_lpReport()
